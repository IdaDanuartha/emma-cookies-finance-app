    ...
    >
      <div className="text-center">
        ...
        <p className="text-sm leading-6 text-gray-500 dark:text-gray-400">
          Apakah Anda yakin ingin menghapus data sumber pendapatan ini? Tindakan ini bersifat permanen dan tidak dapat dibatalkan 
        </p>

        <form onSubmit={handleDelete} className="flex items-center justify-center w-full gap-3 mt-7">
